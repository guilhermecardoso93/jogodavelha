...
function checkingWinner() {
  ...
  if (checkSession(squad4, squad5, squad6)) {
    ...
    changeBackSquad(squad4);
  }

  if (checkSession(squad7, squad8, squad9)) {
    changeWinnerName(squad7, squad8, squad9);
    changeBackSquad(squad7);
  }

  if (checkSession(squad1, squad4, squad7)) {
    changeWinnerName(squad1, squad4, squad7);
    changeBackSquad(squad1);
  }

  if (checkSession(squad2, squad5, squad8)) {
    changeWinnerName(squad2, squad5, squad8);
    changeBackSquad(squad2);
  }

  if (checkSession(squad3, squad6, squad9)) {
    changeWinnerName(squad3, squad6, squad9);
    changeBackSquad(squad3);
  }

  if (checkSession(squad1, squad5, squad9)) {
    changeWinnerName(squad1, squad5, squad9);
    changeBackSquad(squad1);
  }

  if (checkSession(squad3, squad5, squad7)) {
    changeWinnerName(squad3, squad5, squad7);
    changeBackSquad(squad3);
  }
}
